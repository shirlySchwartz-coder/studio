export class Animal {
  ...
  get species(): string { return this.getNameFromRef('species', this.species_id); }
  get size(): string { return this.getNameFromRef('sizes', this.size_id); }
  get gender(): string { return this.getNameFromRef('genders', this.gender_id); }
  get status(): string { return this.getNameFromRef('statuses', this.status_id); }
  get shelter(): string { return this.getNameFromRef('shelters', this.shelter_id); }
  get breed(): string { return this.getNameFromRef('breeds', this.breed_id); }
